    ...
    <div className="flex flex-col gap-8">
      ...
      <div>
        ...
        <div className="mt-3 border border-[var(--color-hairline)] bg-white px-4 py-4 text-xs leading-relaxed text-[var(--color-charcoal)]/70">
          ...
          <p className="mt-1">크기 · {selectedType.size}</p>
        </div>
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="예) 강아지 사진에 'my buddy' 문구 넣고 싶어요"
          rows={4}
...
export default function MugPage() {
  ...
  function setTypeId(next: MugTypeId) {
    setTypeIdState(next);
    const nextType = mugTypes.find((t) => t.id === next)!;
            ...
            <div className="aspect-square w-full overflow-hidden bg-[var(--color-hairline)]/20">
              <img
                ...
                alt={`${selectedType.productLabel}${
                  selectedType.colors.length > 1 ? ` · ${selectedColor.label}` : ""
                }`}
