...
function CaptionSettingsPopover({
 ...
 className=" border border-[var(--color-hairline)] bg-white/90 px-2 py-0.5 text-[10px] "
 >
 Aa
 </button>
 {isOpen && (
 ...
 <p className="text-xs font-semibold">캡션 설정</p>
 <button
 onClick={() => setIsOpen(false)}
 ...
 <p className="mt-3 text-[10px] font-semibold text-[var(--color-charcoal)]/50">서체</p>
 ...
 className={`block w-full px-2 py-1.5 text-left text-xs hover:bg-[var(--color-ivory)] ${
 ...
 <p className="mt-3 text-[10px] font-semibold text-[var(--color-charcoal)]/50">크기</p>
 ...
 <p className="mt-3 text-[10px] font-semibold text-[var(--color-charcoal)]/50">정렬</p>
 <div className="mt-1 flex gap-1">
 ...
 <p className="mt-3 text-[10px] font-semibold text-[var(--color-charcoal)]/50">색상</p>
 ...
 {showPosition && (
 <>
 <p className="mt-3 text-[10px] font-semibold text-[var(--color-charcoal)]/50">위치</p>
 <select
...
function Ruler({
 ...
 const = Math.round(labelMm);
 ticks.push({ labelMm:, rawMm: labelToRawMm(), major: % majorStepMm === 0 });
 }
...
function IntroPagePreview({
 ...
 {coverTitle.trim() && (
 <p className="break-keep text-xs font-bold text-[var(--color-charcoal)]">{coverTitle}</p>
 )}
 <div className="text-[10px] leading-relaxed text-[var(--color-charcoal)]/70">
...
function TextBoxToolbar({
 ...
 className="w-full border border-[var(--color-hairline)] bg-white px-2 py-1.5 text-xs"
 ...
 className="w-24 border border-[var(--color-hairline)] bg-white px-2 py-1.5 text-xs outline-none focus:border-[var(--color-sky)]"
 />
 <span className="text-[10px] text-[var(--color-charcoal)]/40">
 ...
 className="w-full border border-[var(--color-hairline)] bg-white px-2 py-1.5 text-xs outline-none focus:border-[var(--color-sky)]"
 />
 </div>
 <div>
 <label className="mb-1 block text-xs font-medium text-[var(--color-charcoal)]/70">
...
function MultiTextAlignPanel({
 ...
 type="button"
 onClick={onClear}
 className="text-[10px] text-[var(--color-charcoal)]/50 underline underline-offset-4"
 >
 선택 해제
 </button>
 </div>
 <div>
 <p className="mb-1 text-[10px] text-[var(--color-charcoal)]/60">가로 정렬 (선택 영역 기준)</p>
 ...
 {count >= 3 && (
 <div>
 <p className="mb-1 text-[10px] text-[var(--color-charcoal)]/60">균등 분배 (3개 이상일 때만)</p>
 <div className="flex gap-1">
 <button
 type="button"
...
>(function ImageBoxOverlay(
 ...
 그대로예요. */}
 <span className="text-[10px] font-semibold tracking-[0.15em]">PHOTO</span>
 </button>
 )}
 <input
...
function CoverTitleOverlay({
 ...
 className="absolute -top-7 left-1/2 flex h-6 w-6 -translate-x-1/2 cursor-grab items-center justify-center bg-black/60 text-[10px] text-white opacity-0 transition active:cursor-grabbing group-hover/ct:opacity-100"
 >
 ⠿
 </button>
 <p
...
function SpineTitleOverlay({
 ...
 <span
 className="text-[10px] text-[var(--color-charcoal)]/40"
...
function CategoryTabbedGrid({
 ...
 <div className="flex gap-1 overflow-x-auto pb-1 text-[10px]" style={{ scrollbarWidth: "thin" }}>
 {categories.map((cat) => (
 <button
 key={cat.id}
 type="button"
 ...
 <div className="bg-[var(--color-ivory)]/60 p-1.5 text-[10px] text-[var(--color-charcoal)]/60 break-keep">
 {emptyMessage}
 </div>
 ) : (
...
function UploadPageContent() {
 ...
 <p className="text-xs font-semibold">이 템플릿에 쓸 사진을 골라주세요</p>
 <p className="mt-0.5 text-[10px] text-[var(--color-charcoal)]/50">
 ...
 <span className="min-w-0 max-w-[40vw] truncate text-xs font-medium text-[var(--color-charcoal)]/80 sm:max-w-xs">
 ...
 <p className="text-xs font-medium">🧪 새 PDF 생성기 테스트 (pdf-lib) — 주문/저장과 무관해요</p>
 ...
 className="mt-3 bg-[var(--color-charcoal)] px-2 py-2 text-xs text-white transition disabled:opacity-50"
 >
 ...
 <p className="text-xs font-medium">🧪 표지 펼침면 테스트 (바깥면+안쪽면 2쪽)</p>
 <p className="mt-1 text-xs text-[var(--color-charcoal)]/60 break-keep">
 ...
 >
 <span className="pointer-events-none bg-black/60 px-2.5 py-2.5 text-xs font-medium text-white opacity-0 transition group-hover:opacity-100">
 ✏️ 편집하기
 </span>
 </button>
 )}
 {selectedPageKey === "cover" ? (
 <div className="flex h-full min-h-0 flex-col border border-[var(--color-hairline)] bg-white p-2.5">
 <div className="shrink-0">
 <p className="text-xs font-medium">표지</p>
 </div>
 ...
 <p className="mt-1 text-[10px] text-[var(--color-charcoal)]/50 break-keep">
 ...
 className="flex h-7 w-7 items-center justify-center bg-white text-xs text-[var(--color-charcoal)]/70 "
 >
 −
 </button>
 <button
 ...
 className="bg-white px-1.5 py-1 text-[10px] text-[var(--color-charcoal)]/70 "
 >
 초기화
 </button>
 <button
 ...
 className="bg-[var(--color-charcoal)] px-1.5 py-1 text-[10px] text-white"
 >
 완료
 </button>
 </div>
 ...
 className="mt-2 bg-white px-1.5 py-1 text-[10px] text-[var(--color-charcoal)]/70 "
 >
 가운데로 초기화
 </button>
 </div>
 ...
 <p className="bg-[var(--color-ivory)] px-1.5 py-2 text-[10px] text-[var(--color-charcoal)]/60 break-keep">
 ...
 <p className="text-[10px] text-[var(--color-charcoal)]/50 break-keep">
 ...
 className="border border-[var(--color-hairline)] px-1.5 py-1 text-[10px] text-[var(--color-charcoal)]/60 transition hover:bg-white"
 >
 로고 빼기
 </button>
 ) : (
 ...
 className="bg-[var(--color-brand-purple)] px-1.5 py-1 text-[10px] text-white"
 >
 + 로고 추가
 </button>
 )}
 ...
 className={`border px-1.5 py-1 text-[10px] transition ${
 target === opt.id
 ? "border-[var(--color-sky)] bg-[var(--color-sky)]/10 text-[var(--color-sky)]"
 ...
 <p className="mt-1 text-[10px] text-[var(--color-charcoal)]/50">
 ...
 <p className="bg-[var(--color-ivory)] px-1.5 py-2 text-[10px] text-[var(--color-charcoal)]/70 break-keep">
 {coverLayoutApplyMessage}
 </p>
 )}
 <div className="grid grid-cols-2 gap-2">
 ...
 <p className="col-span-2 text-[10px] text-[var(--color-charcoal)]/40">
 이 조건에 맞는 템플릿이 없어요.
 </p>
 )}
 </div>
 ...
 rows={2}
 className="flex-1 resize-none border border-[var(--color-hairline)] bg-white px-2 py-1.5 text-xs outline-none focus:border-[var(--color-sky)]"
 />
 ...
 className="w-24 border border-[var(--color-hairline)] bg-white px-2 py-2.5 text-xs outline-none focus:border-[var(--color-sky)]"
 />
 ...
 className="w-full border border-[var(--color-hairline)] bg-white px-2 py-2.5 text-xs outline-none focus:border-[var(--color-sky)]"
 />
 </div>
 <div>
 <label className="mb-1 block text-xs font-medium text-[var(--color-charcoal)]/70">
 ...
 <label className="mb-2 flex items-center gap-2 text-[10px] text-[var(--color-charcoal)]/70">
 <input
 type="checkbox"
 ...
 className="w-20 border border-[var(--color-hairline)] bg-white px-2 py-2.5 text-xs outline-none focus:border-[var(--color-sky)]"
 />
 <button
 type="button"
 ...
 <p className="mt-1.5 text-[10px] text-amber-700 break-keep">
 ...
 className={`h-6 border px-2 text-[10px] transition ${
 !backCoverPatternId
 ? "border-[var(--color-charcoal)] bg-[var(--color-charcoal)] text-white"
 : "border-[var(--color-hairline)] bg-white text-[var(--color-charcoal)]/70"
 }`}
 ...
 <div className="flex h-full min-h-0 flex-col border border-[var(--color-hairline)] bg-white p-2">
 <div className="shrink-0">
 <p className="text-xs font-medium">마지막 소개 페이지</p>
 <p className="mt-1 text-xs text-[var(--color-charcoal)]/60 break-keep">
 ...
 className="mt-1 w-full border border-[var(--color-hairline)] px-2 py-1.5 text-xs"
 />
 </label>
 <label className="text-xs text-[var(--color-charcoal)]/70">
 만든이
 ...
 className="flex h-7 w-7 items-center justify-center border border-[var(--color-hairline)] text-xs disabled:opacity-30"
 >
 ‹
 </button>
 <button
 ...
 {lowResCount > 0 && (
 <p className="mt-2 bg-red-50 px-1.5 py-2 text-[10px] text-red-600 break-keep">
 ...
 <div className="mt-3">
 {pageCount > 1 && (
 <div className="mb-2 flex items-center justify-between gap-2 text-[10px] text-[var(--color-charcoal)]/60">
 <button
 type="button"
 ...
 >
 {isPrintPreview && (
 <div className="pointer-events-none absolute inset-8 bg-white -[0_25px_55px_-12px_rgba(0,0,0,0.5)] sm:inset-12" />
 )}
 <div
 ...
 className="flex h-8 w-8 shrink-0 items-center justify-center border border-[var(--color-hairline)] bg-white text-xs transition disabled:opacity-30"
 aria-label="이전 페이지"
 >
 ‹
 </button>
 ...
 rows={4}
 className="mt-3 w-full resize-none border border-[var(--color-hairline)] bg-white px-2 py-1.5 text-xs outline-none focus:border-[var(--color-sky)]"
 />
 </div>
 )}

 <label className="mt-8 inline-block cursor-pointer bg-[linear-gradient(135deg,var(--color-brand-purple),var(--color-sky))] px-2 py-2 text-xs font-medium text-white transition hover:opacity-90">
 사진 선택하기
 <input type="file" accept="image/*" onChange={handleFileSelect} className="hidden" />
 </label>

 {photos.length === 1 && isLowRes(photos[0], requiredMinPx) && (
 <p className="mt-4 bg-red-50 px-2 py-1.5 text-xs text-red-600 break-keep">
 ...
 {photos.length === 1 && (
 <div className="mt-12">
 <h2 className="text-xs font-semibold">미리보기</h2>
 ...
 disabled={isSaving}
 className={`mt-10 px-2 py-2 text-xs font-medium text-white transition ${
 isSaving
 ? "cursor-not-allowed bg-[var(--color-hairline)] text-white/70"
 : "bg-[var(--color-charcoal)] hover:opacity-90"
 }`}
