...
const faqs = [
  ...
  {
    q: "사진은 몇 장 준비해야 하나요?",
    a: "상품마다 달라요. 포토북은 최소 10장~최대 100장, 나만의 앨범은 최소 5장~최대 50장, 액자는 1장이면 충분해요. 정확한 매수는 상품 선택 화면에서 확인하실 수 있어요.",
  },
  {
      ...
      <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-8 sm:px-10">
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          <nav className="hidden gap-8 text-sm sm:flex">
            ...
            <Link href="/faq" className="text-[var(--color-sky)]">자주 묻는 질문</Link>
